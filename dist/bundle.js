...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _incrementalDom = __webpack_require__(393);

	var renderTodo = function renderTodo() {
	    (0, _incrementalDom.patch)(document.body, _view.render);
	};
	_state.todos.subscribe(renderTodo);
	renderTodo();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var taskList = (0, _localStorage.storage)();
	var taskItems = getTodoList(taskList.getItem());
	...
	if (taskItems.length) {
	    newInitialState = (0, _assign2.default)({}, initialState, {
	        todos: taskItems
	    });
	} else {
	    initialState.todos.forEach(function (v, i) {
	        taskList.addTodoItem(v, i);
	    });
	}

	var todoChangeHandler = function todoChangeHandler() {
	    ...
	    switch (action.type) {
	        ...
	        case 'TODO_TOGGLE_DONE':
	            var _todos = state.todos,
	                index = action.id;
	            var updatedTodo = (0, _assign2.default)({}, _todos[index], { done: !_todos[index].done });
		...
		var todos = exports.todos = (0, _redux.createStore)(todoChangeHandler);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(311)(IteratorPrototype, __webpack_require__(359)('iterator'), function(){ return this; });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _combineReducers = __webpack_require__(383);
	...
	var _compose = __webpack_require__(387);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _symbolObservable = __webpack_require__(379);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseGetTag = __webpack_require__(370),
	    getPrototype = __webpack_require__(376),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Symbol = __webpack_require__(371),
	    ...
	    objectToString = __webpack_require__(375);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function storage() {
	    ...
	    return {
	        setItem: localStorage.setItem(key, (0, _stringify2.default)(storage)),
	        getItem: function getItem() {
	            return JSON.parse(localStorage.getItem(key));
	        },
	        addTodoItem: function addTodoItem(newItem, itemId) {
	            storage[itemId] = newItem;
	            localStorage.setItem(key, (0, _stringify2.default)(storage));
	        },
	        updateTodoItem: function updateTodoItem(updatedItem, itemId) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _feature = __webpack_require__(392);
	...
	var elementOpen = _incrementalDom2.default.elementOpen,
	    elementClose = _incrementalDom2.default.elementClose,
	    elementVoid = _incrementalDom2.default.elementVoid,
	    text = _incrementalDom2.default.text,
	    patch = _incrementalDom2.default.patch;
	function render() {
	    elementOpen('div');

	    _renderArbitrary((0, _feature.isEnabled)('renderBottom') ? renderAddTodoAtBottom() : renderAddTodoAtTop());

	    _renderArbitrary((0, _feature.isEnabled)('filters') ? showFilters() : '');
	...
	function renderInput() {
	    elementOpen('div', null, null, 'class', 'todo__input');
	    elementVoid('input', null, null, 'type', 'text', 'id', 'todoInput');
	    elementOpen('button', null, null, 'id', 'addTodo');
	    text('Add');
	    elementClose('button');
	    return elementClose('div');
	}
	...
	function showFilters() {
	    var status = _state.todos.getState().filterState;
	    var options = ['all', 'open', 'closed'];

	    elementOpen('div', null, null, 'class', 'todo__filter');

	    _renderArbitrary(options.map(function (value, i) {
	...
	function showOptions(value, filterStatus) {
	    elementOpen('label');
	    elementVoid('input', null, null, 'checked', filterStatus === value || undefined, 'value', value, 'type', 'radio', 'name', 'filter', 'class', 'todo_filter');
	    text(' Show ');

	    _renderArbitrary(value);

	    return elementClose('label');
	}

	function renderTodos() {
	    var state = _state.todos.getState();
	    var todoItems = state.todos.filter(function (v, i) {
	        return state.filterState === "all" ? true : state.filterState === "open" ? v.done === false : v.done === true;
	    });
	    elementOpen('ul', null, null, 'class', 'todo');

	    _renderArbitrary(todoItems.map(renderTodoItem));
	...
	function renderTodoItem(todo) {
	    ...
	    elementVoid('input', null, null, 'data-id', todo.id, 'checked', todo.done ? todo.done : undefined, 'class', 'js_toggle_todo', 'type', 'checkbox');

	    _renderArbitrary(todo.text);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function registerEventHandlers() {
	    ...
	    (0, _events.listen)('click', '.todo_filter', function (event) {
	        var filterType = event.target.value;
	        _state.todos.dispatch((0, _actions.filterTodo)(filterType));
	    });
